...
<p><?php if (count($this->desc) > 0 && $this->desc[0]->turnstiles != null && JComponentHelper::getParams('com_railway2')->get('page_station_show_wayout', '0') != '0') echo $this->loadTemplate('detour');?></p>
